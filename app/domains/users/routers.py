...
class UsersController(Controller):
    ...
    async def register(self, users_service: FromDishka[UserService], data: RegisterRequest) -> Response[UserPublic]:
    ...
    async def login(self, users_service: FromDishka[UserService], data: LoginRequest) -> Response[UserPublic]:
    ...
    @get('/me')
    async def get_me(self, request: Request[User, Token, Any], users_service: FromDishka[UserService]) -> UserPublic:
...
class AdminController(Controller):
    ...
    @patch('/ban')
    async def ban_user(self, users_service: FromDishka[UserService], data: UserBan) -> UserPublic:
