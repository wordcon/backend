...
class Settings(LitestarSettings):
    service_debug: bool = os.getenv("SERVICE_DEBUG", "false").lower() in {"1", "true", "yes", "on"}
    ...
    swagger_offline_docs: bool = os.getenv("SWAGGER_OFFLINE_DOCS", "false").lower() in {"1", "true", "yes", "on"}
